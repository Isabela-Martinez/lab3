...
public class ProtocoloCliente 
{
	...
	{   
		try {
            PrintWriter writer = new PrintWriter("home/servidor/aplicacion/lab3/Data/ArchivosRecibidos/Cliente" + id + "-Prueba" + cantConexiones + ".txt", "UTF-8");
	...
	public static void createLog(String content, String idCliente) throws IOException
	{
		...
		try {
            PrintWriter writer = new PrintWriter("home/servidor/aplicacion/lab3/Data/logs/" + h2 + "-client" + idCliente + ".log", "UTF-8");
            writer.println(content);
            writer.close();
        } catch (Exception e) {
            e.printStackTrace();
